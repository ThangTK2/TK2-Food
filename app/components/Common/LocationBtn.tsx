...
const LocationBtn = () => {
  ...
  return (
    <>
      <button
        onClick={openModal}
        className={`flex items-center px-3 py-2 bg-slate-200 rounded-full md:max-w-sm  md:rounded-lg`}
      >
        {" "}
        ...
        <span className={"truncate max-w-[8rem] text-sm text-gray-500 md:max-w-[12rem] pr-1"}>
