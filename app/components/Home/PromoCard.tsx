  ...
  return (
    ...
    hover:text-green-600 transition-all duration-200 ease-out">
      <div className="flex flex-1 relative overflow-hidden">
        <span className="absolute rotate-[50deg] top-4 right-1 px-4 py-2 rounded-br-[4px] bg-red-500 text-white text-center ">
          {/* rotate-[50deg] sử dụng để áp dụng một phép biến đổi xoay (rotate transformation) với một góc cụ thể là 50 độ */}
          {promo.PercentOff} % Off
        </span>
        <Image className="rounded-lg" src={promo.img} width={200} height={200} alt="promo-img" />
      </div>
