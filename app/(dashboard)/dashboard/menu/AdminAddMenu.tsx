...
const AdminAddMenu = () => {
  ...
  return (
    <>
      <button className="text-white inline-flex items-center whitespace-nowrap bg-green-600
      ...
      <Modal isOpen={isOpen} title={title} closeModal={closeModal}>
        <form onSubmit={handleAddMenu}>
          <div className="grid gap-4 mb-4 sm:grid-cols-2">
            <div>
              ...
              <input className="form-input"
                type="text" name="name" id="name" value={title}
            ...
            <div className=" sm:col-span-2">
              ...
              <div className="flex sm:col-span-2">
                <input className="form-input"
                  type="text" value={preparationInput}
          ...
          <div className="pt-2 flex justify-center">
            <button className="text-white inline-flex items-center bg-green-600 hover:bg-green-700 focus:ring-4 
